...
function CampaignPage() {
  ...
  const [editedCampaignDescription, setEditedCampaignDescription] =
    useState("");
  ...
  const fetchCreatorName = async () => {
    try {
      const response = await axiosInstance.get(
        `http://localhost:4000/api/user/name/${campaignID}`
      );
    ...
    <div className="campaignPage">
      {campaign && (
        <div>
          <div
            className="d-flex"
            style={{ marginTop: "75px", marginLeft: "1300px" }}
          >
                ...
                <Form>
                  ...
                  >
                    ...
                    <Form.Control
                      ...
                      onChange={(e) =>
                        setEditedCampaignDescription(e.target.value)
                      }
                      rows={5}
                    />
                  </Form.Group>
                  ...
                  >
                    ...
                    <Form.Control
                      ...
                      onChange={(e) =>
                        setEditedCampaignCategory(e.target.value)
                      }
                    />
                  </Form.Group>
                  ...
                  <div className="dates">
                    <div className="start-date">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          setEditedCampaignStartDate(e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div className="start-date">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          setEditedCampaignEndDate(e.target.value)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <Form.Group controlId="exampleForm.ControlInput4">
                    ...
                    <Form.Control
                      type="file"
                      onChange={(e) =>
                        setEditedCampaignImage(e.target.files[0])
                      }
                    />
                  </Form.Group>
                </Form>
          ...
          <div
            className="d-flex"
            style={{ marginTop: "-37px", marginLeft: "1450px" }}
          >
            ...
            >
              ...
              <Modal.Body>
                Are you sure you want to delete this campaign? You will lose all
                progress for this campaign and this action cannot be taken back!
              </Modal.Body>
              <Modal.Footer>
                <Button
                  variant="secondary"
          ...
          <div className="campaign-title">
            ...
            <h2>
              {" "}
              Fundraising Campaign created by{" "}
              {creatorName &&
                `${creatorName.firstName} ${creatorName.lastName}`}{" "}
              <BsDot /> {campaign.category} <BsDot /> {campaign.country}
            </h2>
